...
فرمت خروجی دقیق:
🧩 جمع‌بندی کوتاه
(3 تا 5 جمله از مهم‌ترین وضعیت کلی)

🔥 مهم‌ترین رویدادها
(5 تا 8 مورد؛ هر مورد شامل: عنوان کوتاه + شرح 2 تا 3 جمله + منبع/منابع)

📌 نکات کلیدی و الگوها
(3 تا 6 نکته تحلیلی از روندها و ارتباط خبرها)

✅ جمع‌بندی نهایی
(2 تا 4 جمله با تصویر کلی و ریسک‌های احتمالی نزدیک)
